...
// Public routes (assuming public for halls listing)
...
Route::middleware(['auth:sanctum', 'manager'])->group(function () {
    ...
    Route::put('/halls/{hall}', [AdminHallController::class, 'update']);
    Route::delete('/halls/{hall}', [AdminHallController::class, 'destroy']);
