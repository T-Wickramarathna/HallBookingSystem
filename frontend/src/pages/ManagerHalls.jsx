...
const ManagerHalls = () => {
  ...
  const fetchHalls = async () => {
    try {
      ...
      // The API returns paginated data or an array. Let's assume an array for now, or response.data.data
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (editId) {
        ...
        await api.post(`/halls/${editId}`, data, {
          headers: {
      ...
      Swal.fire({
        icon: 'error',
        title: 'Error',
        text: error.response?.data?.message || 'Failed to create hall. Please try again.'
      });
    } finally {
  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 tracking-tight">Manage Halls</h1>
          <p className="text-gray-500 mt-1">Add, update or remove your event spaces</p>
        </div>
        <button
          onClick={() => {
            setEditId(null);
          ...
          {Math.ceil(halls.length / itemsPerPage) > 1 && (
            <div className="flex justify-center items-center gap-4 mt-8 col-span-full">
              <button
                ...
                className="px-4 py-2 border border-gray-200 rounded-xl disabled:opacity-50 hover:bg-gray-50 transition-colors text-sm font-medium"
              >
                Previous
              </button>
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none transition-all bg-gray-50 focus:bg-white"
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none transition-all bg-gray-50 focus:bg-white appearance-none"
                  >
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-indigo-600 focus:border-transparent outline-none transition-all bg-gray-50 focus:bg-white resize-none"
                  placeholder="Describe the hall's features and amenities..."
                ></textarea>
              </div>
              ...
              <div className="flex justify-end gap-3 pt-4 border-t border-gray-100">
                ...
                <button
                  ...
                  className="px-5 py-2.5 bg-indigo-600 text-white rounded-xl font-medium hover:bg-indigo-700 transition-colors disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2 shadow-sm"
                >
